...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($email) || empty($wachtwoord)) {
        ...
        $fout = 'Inloggen is tijdelijk niet mogelijk. Probeer het later opnieuw.';
    } else {
        try {
            ...
            if ($gebruiker && password_verify($wachtwoord, $gebruiker['wachtwoord'])) {
                ...
                $fout = 'Ongeldige e-mail of wachtwoord.';
            }
    ...
    <div class="card">
        ...
        <form method="POST">
            ...
            <div class="btn-row">
                ...
                <a href="account.php" class="link-sec">Nog geen account? Registreren →</a>
            </div>
        </form>
    </div>
</div>
